...
void Intro::pickDataDirectory()
{
    ...
    if(!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false))
    {
        ...
        intro.setWindowIcon(QIcon(":icons/mtcoin"));
        ...
        while(true)
        {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("MTcoin"),
     ...
     * override -datadir in the mtcoin.conf file in the default data directory
     * (to be consistent with mtcoind behavior)
     */
    if(dataDir != getDefaultDataDirectory())
