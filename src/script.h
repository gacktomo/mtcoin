...
#ifndef H_MTcoin_SCRIPT
#define H_MTcoin_SCRIPT
 ...
 *  A CTxDestination is the internal data type encoded in a CMTcoinAddress
 */
...
public:
    ...
    // Pre-version-0.6, MTcoin always counted CHECKMULTISIGs
