/* src/mtcoin-config.h.  Generated from mtcoin-config.h.in by configure.  */
/* src/mtcoin-config.h.in.  Generated from configure.ac by autoheader.  */

#ifndef MTcoin_CONFIG_H

#define MTcoin_CONFIG_H
...
#define PACKAGE_BUGREPORT "info@mtcoin.org"

/* Define to the full name of this package. */
#define PACKAGE_NAME "MTcoin Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "MTcoin Core 0.9.5"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "mtcoin"
