...
public:
    CMainParams() {
        ...
        vSeeds.push_back(CDNSSeedData("mtcoin.sipa.be", "seed.mtcoin.sipa.be"));
        vSeeds.push_back(CDNSSeedData("bluematt.me", "dnsseed.bluematt.me"));
        vSeeds.push_back(CDNSSeedData("dashjr.org", "dnsseed.mtcoin.dashjr.org"));
        vSeeds.push_back(CDNSSeedData("mtcoinstats.com", "seed.mtcoinstats.com"));
...
public:
    CTestNetParams() {
        ...
        vFixedSeeds.clear();
        vSeeds.clear();
        vSeeds.push_back(CDNSSeedData("mtcoin.petertodd.org", "testnet-seed.mtcoin.petertodd.org"));
