// Copyright (c) 2012-2013 The MTcoin Core developers
...
{
    BOOST_CHECK(TestSplitHost("www.mtcoin.org", "www.mtcoin.org", -1));
    BOOST_CHECK(TestSplitHost("[www.mtcoin.org]", "www.mtcoin.org", -1));
    BOOST_CHECK(TestSplitHost("www.mtcoin.org:80", "www.mtcoin.org", 80));
    BOOST_CHECK(TestSplitHost("[www.mtcoin.org]:80", "www.mtcoin.org", 80));
