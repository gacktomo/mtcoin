...
if [ -d "$OUT_DIR" -a -w "$OUT_DIR" ]; then
  set +e
  # Windows:
  cp /Users/mori/Documents/bitcoin/win32-build/src/mtcoind.exe $OUT_DIR/mtcoind.exe
  cp /Users/mori/Documents/bitcoin/win32-build/src/test/test_mtcoin.exe $OUT_DIR/test_mtcoin.exe
  cp /Users/mori/Documents/bitcoin/win32-build/src/qt/mtcoind-qt.exe $OUT_DIR/mtcoin-qt.exe
  # Linux:
  cp /Users/mori/Documents/bitcoin/linux-build/src/mtcoind $OUT_DIR/mtcoind
  cp /Users/mori/Documents/bitcoin/linux-build/src/test/test_mtcoin $OUT_DIR/test_mtcoin
  cp /Users/mori/Documents/bitcoin/linux-build/src/qt/mtcoind-qt $OUT_DIR/mtcoin-qt
  set -e
fi

# Run unit tests and blockchain-tester on Linux:
cd /Users/mori/Documents/bitcoin/linux-build
make check

# Run RPC integration test on Linux:
/Users/mori/Documents/bitcoin/qa/rpc-tests/wallet.sh /Users/mori/Documents/bitcoin/linux-build/src
/Users/mori/Documents/bitcoin/qa/rpc-tests/listtransactions.py --srcdir /Users/mori/Documents/bitcoin/linux-build/src
# Clean up cache/ directory that the python regression tests create
rm -rf cache

if [ $RUN_EXPENSIVE_TESTS = 1 ]; then
  # Run unit tests and blockchain-tester on Windows:
  cd /Users/mori/Documents/bitcoin/win32-build
  make check
fi
