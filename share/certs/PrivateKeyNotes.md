...
unlocked to sign the MTcoin-Qt.app bundle.
...
allowing somebody to distribute a MTcoin-Qt.app or mtcoin-qt-setup.exe with a valid
...
that the mtcoin-qt.exe file inside the installer had not been tampered with.
