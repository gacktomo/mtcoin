The following is a list of assets used in the mtcoin source and their proper attribution.
...
* License: MIT
* Site: [https://mtcointalk.org/index.php?topic=15276.0](https://mtcointalk.org/index.php?topic=15276.0)
...
### Info
* Designer: Jonas Schnelli (based on the original mtcoin logo from Bitboy)
* License: MIT

### Assets Used
	src/qt/res/icons/mtcoin.icns, src/qt/res/src/mtcoin.svg,
	src/qt/res/src/mtcoin.ico, src/qt/res/src/mtcoin.png,
	src/qt/res/src/mtcoin_testnet.png, docs/mtcoin_logo_doxygen.png,
