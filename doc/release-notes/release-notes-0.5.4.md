MTcoin version 0.5.4 is now available for download at:
http://sourceforge.net/projects/mtcoin/files/MTcoin/mtcoin-0.5.4/
...
http://gitorious.org/mtcoin/mtcoind-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix MTcoin-Qt notifications under Growl 1.3.
Increase required age of MTcoin-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxMTcoin properly when installing MTcoin-Qt over it. (Windows)
