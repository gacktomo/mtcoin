MTcoin-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/mtcoin/files/MTcoin/mtcoin-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the MTcoin
...
New/changed settings (command-line or mtcoin.conf file)
--------------------------------------------------------
